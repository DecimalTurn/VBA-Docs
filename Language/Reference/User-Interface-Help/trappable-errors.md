...
Trappable errors can occur while an application is running. Some trappable errors can also occur during development or [compile time](../../Glossary/vbe-glossary.md#compile-time). You can test and respond to trappable errors using the  [**On Error** statement](../../reference/user-interface-help/on-error-statement) and the [**Err** object](../../reference/user-interface-help/err-object). Unused [error numbers](../../Glossary/vbe-glossary.md#error-number) in the range 1 - 1000 are reserved for future use by Visual Basic.
